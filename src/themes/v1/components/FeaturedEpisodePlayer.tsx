  ...
  return (
    <div className="bg-white rounded-xl p-5 md:p-6 shadow-sm">
      ...
      <div className="md:hidden">
        ...
        <p className="text-sm text-gray-600 mb-4 leading-relaxed line-clamp-3">{description}</p>
      ...
      <div className="hidden md:flex gap-6">
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm md:text-base text-gray-600 mb-3 leading-relaxed line-clamp-3">{description}</p>
